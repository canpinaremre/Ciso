...
void GuiMain::MenuBar()
{
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Help"))
        {
            ...
            {
                ShellExecute(NULL, NULL, "https://github.com/canpinaremre/ciso", NULL, NULL, SW_SHOWNORMAL);
            }
...
void GuiMain::Draw(bool *stay_open)
{
    ...
    if (ImGui::IsKeyDown(ImGuiKey_ModCtrl) && ImGui::IsKeyDown(ImGuiKey_S) && ImGui::IsKeyDown(ImGuiKey_LeftShift))
    {
